...
awful.screen.connect_for_each_screen(function(s)
    ...
    awful.tag({ "1", "2", "Cool", "4", "5", "6", "7", "8", "9" }, s, awful.layout.layouts[1])
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey }, "p", function() menubar.show() end,
              ...
              --
    -- Custom
    awful.key({ modkey, "Control", "Shift" }, "k",     function () awful.tag.incncol( 1, nil, true)    end,
              {description = "increase the number of columns", group = "layout"}),
    awful.key({ modkey, "Control", "Shift" }, "j",     function () awful.tag.incncol(-1, nil, true)    end,
...
clientkeys = gears.table.join(
    ...
    {description = "swap client with upper neighbour", group = "layout"}),

    awful.key({ modkey, "Control"   }, "j",     function(c)
        awful.client.swap.global_bydirection("down")
        c:raise()
    end,
    {description = "swap client with down neighbour", group = "layout"}),

    awful.key({ modkey, "Control"   }, "h",     function(c)
        awful.client.swap.global_bydirection("left")
        c:raise()
    end,
    {description = "swap client with left neighbour", group = "layout"}),

    awful.key({ modkey, "Control"   }, "l",     function(c)
        awful.client.swap.global_bydirection("right")
        c:raise()
    end,
    {description = "swap client with right neighbour", group = "layout"})
